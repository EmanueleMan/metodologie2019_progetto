 ...
 * Il tipo di ritorno  e' generico in quanto a seconda del target della nostra applicazione possiamo restituire formati diversi
...
public interface DataProvider<T> {
	...
	/**
	 * Restituisce un oggetto di tipo  per il Task passato in input.
	 * */
	T getData(Task task);
