...
public class TaskSenseValidationServlet extends BaseServlet implements MetodiServlet
{
	 ...
	 * nome della pagina
	 */
	private final String pagina = "senseValidation";
	...
	{	
		...
		if (isLoggedIn)
		{
			...
			String radio = controlla(createArrayRadio(request), request);
			...
			{
				salvaPagina(pagina, pagine, diz, radio, response);
			}
