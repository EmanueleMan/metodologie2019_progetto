...
public class TaskDefinitionAnnotationServlet extends BaseServlet implements MetodiServlet
{
	 ...
	 * nome della pagina
	 */
	private final String pagina = "definitionAnnotation";
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (isLoggedIn)
		{
			...
			String definition = request.getParameter("definizione");
			...
			{
				salvaPagina(pagina, pagine, diz, definition, response);
			}
		}
